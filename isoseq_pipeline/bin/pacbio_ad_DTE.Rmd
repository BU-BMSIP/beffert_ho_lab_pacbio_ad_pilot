...
new_col_names <- c("transcript","bc01_CTRL", "bc02_CTRL", "bc03_CTRL", "bc04_CTRL", "bc09_AD", "bc10_AD", "bc11_AD", "bc12_AD")

counts <- read.delim("../results/isoquant/isoquant.discovered_transcript_grouped_counts.linear.tsv", header=TRUE, sep="\t") %>%
...
row.names(counts_matrix) <- counts_filtered$transcript
```
